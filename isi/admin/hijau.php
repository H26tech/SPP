...
// Query to count paid students per class and major
$query = "
    SELECT ds.jurusan, ds.kelas, COUNT(tt.nis) AS jumlah_lunas
...
<body>
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="section-title">Jumlah Lunas Per Kelas dan Jurusan</div>
            <div class="card">
